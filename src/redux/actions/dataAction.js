import {
    LOADING_DATA, SET_SCREAMS, LIKE_SCREAM, UNLIKE_SCREAM, DELETE_SCREAM,
    LOADING_UI, CLEAR_ERRORS, SET_ERRORS, POST_SCREAM, SET_SCREAM, STOP_LOADING_UI, POST_COMMENT, SHOW_DIALOG, HIDE_DIALOG
} from '../types.js';
